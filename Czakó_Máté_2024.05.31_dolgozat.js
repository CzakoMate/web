...
function removeFirstAndLast(string) {
    ...
    if(arr.length==0||arr.length==1||arr.length==2){
        ...
        return eredm.substring(0,eredm.length-1);
    }
}
...
function dnaStrand(dna){
    ...
    for(let i=0;i<Arr.length;i++){
        switch(Arr[i]){
            case 'A':eredm+='T';break;
            case 'T':eredm+='A';break;
            case 'C':eredm+='G';break;
            case 'G':eredm+='C';break;
            default:eredm+='';break;
        }
...
function deEmojify(emojiString) {
    ...
    for(let x of tomb2){
        ...
        {
            case ":)":szamok+='0';break;
            case ":D":szamok+='1';break;
            case ">(":szamok+='2';break;
            case ">:C":szamok+='3';break;
            case ":/":szamok+='4';break;
            case ":|":szamok+='5';break;
            case ":O":szamok+='6';break;
            case ";)":szamok+='7';break;
            case "^.^":szamok+='8';break;
            case ":(":szamok+='9';break;
            default:console.log("hiba");break;
        }
    }
    karakterek.push(szamok);
